export function buildPromptTxt(plainText, language = "en") {
  const langInstruction = language === "es"
    ? "Responde en español."
    : "Respond in English.";
  return `Eres un experto en análisis de código. A partir del siguiente análisis técnico de un proyecto real, genera un informe con estos apartados. IMPORTANTE: Basa tu respuesta ÚNICAMENTE en la información proporcionada. NO inventes módulos, archivos o funcionalidades que no aparezcan en el análisis.
