export function buildPromptTxt(plainText) {
...
Responde en español. Usa SOLO texto plano. NO uses markdown, negritas, tablas ni enlaces. Separa las secciones con líneas de guiones (----).
Análisis técnico:
${plainText}
Informe:`;
}
