export function buildPromptMd(plainText, language = "en") {
  const langInstruction =
    language === "es" ? "Responde en español." : "Respond in English.";
  return `${langInstruction} Eres un experto en análisis de código. A partir del siguiente análisis técnico de un proyecto real, genera un informe ${langInstruction} con estos apartados. IMPORTANTE: Basa tu respuesta ÚNICAMENTE en la información proporcionada. NO inventes módulos, archivos o funcionalidades que no aparezcan en el análisis.
...
${langInstruction}. Usa formato Markdown: ## para títulos, **negritas** para términos clave, 'codigo' para fragmentos de código, y tablas cuando sea necesario.
Análisis técnico:
${plainText}
Informe:`;
}
